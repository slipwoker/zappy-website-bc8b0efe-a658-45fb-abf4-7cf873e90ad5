document.addEventListener('DOMContentLoaded', function () {
  ...
  function showFieldError(field, message) {
    ...
    field.addEventListener('input', function onInput() {
      ...
      const msg = wrapper.querySelector('.form-error-message');
      if (msg) msg.remove();
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'bc8b0efe-a658-45fb-abf4-7cf873e90ad5',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'bc8b0efe-a658-45fb-abf4-7cf873e90ad5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'bc8b0efe-a658-45fb-abf4-7cf873e90ad5';
